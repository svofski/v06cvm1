...
#TESTS="ADDRMODES MOV MOVB MOVB2 FLAGSR CLR COM INC INCB NEG BR BRCOND SOB JMP JSR ROR RORB ADD SUB CMP CMPB MARK SXT BIT BITB RTI TRAP ADC ADCB SBC SBCB"
TESTS="SBCB"
