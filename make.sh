...
./TASM.EXE -b -85 -DTEST_$TESTS=1 $WITH_KVAZ $TESTBENCH $ROM vm1.asm vm1.com |& tee tasm.log
...
for test in $TESTS ; do
  ...
  ./TASM.EXE -b -85 -DTEST_$test=1 $WITH_KVAZ $TESTBENCH $ROM vm1.asm vm1.com >> tasm.log 2>&1
